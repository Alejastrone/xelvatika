...
public:
    CMainParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 75); // Comienza con X	Para direcciones públicas normalesn X
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 50); // 	Comienza con M	Para direcciones tipo P2SH
        base58Prefixes[SECRET_KEY]     = std::vector<unsigned char>(1, 203); // Comienza con 7	Claves privadas WIF
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF}; // Prefijo para xpub-like pero personalizado
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94}; // Prefijo para xprv-like pero personalizado
